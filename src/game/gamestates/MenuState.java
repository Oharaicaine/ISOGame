...
public class MenuState extends State{
	...
	public MenuState() {
		buttonMesh = new VertexArray(Index.vertciesWidthHeight(200f, 100f, 0.1f), Index.indices(), Index.tcs());
		backgroundMesh = new VertexArray(Index.vertciesWidthHeight(Main.width, Main.height, 0.0f), Index.indices(), Index.tcs());
